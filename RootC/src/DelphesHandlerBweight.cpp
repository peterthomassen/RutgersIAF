...
//------------------------------------------
//------------------------------------------
void DelphesHandler::addBjetSignature(Signature* sig, int low, int high)
{
...
//------------------------------------------
//------------------------------------------
void DelphesHandler::addBjetSignature(const char* name, const char* options, int low, int high)
{
...
//------------------------------------------
//------------------------------------------
int DelphesHandler::getBTagWeight(vector<float> scaleFactors,vector<int>tags){
...
//------------------------------------------
//------------------------------------------
vector<float> DelphesHandler::getLightScaleFactors()
{
  vector<float> sfs;
  for(int i = 0; i < (int)m_good_jets.size(); i++){
...
//------------------------------------------
//------------------------------------------
vector<float> DelphesHandler::getCScaleFactors()
{
  vector<float> sfs;
  for(int i = 0; i < (int)m_good_jets.size(); i++){
...
//------------------------------------------
//------------------------------------------
vector<float> DelphesHandler::getBScaleFactors()
{
  vector<float> sfs;
  for(int i = 0; i < (int)m_good_jets.size(); i++){
...
//------------------------------------------
//------------------------------------------
bool DelphesHandler::isBTagged(SignatureObjectJet* jet)
{
  if(jet->getBDiscriminator_combined() > 0)return true;
  return false;
}
//------------------------------------------
//------------------------------------------
vector<int> DelphesHandler::associateJetsToPartons()
{
...
//------------------------------------------------
//------------------------------------------------
TF1* DelphesHandler::GetSFLight(TString meanminmax, TString Atagger, float Etamin, float Etamax)
{
  TF1 *tmpSFl = NULL;
...
//------------------------------------------------
//------------------------------------------------
TF1* DelphesHandler::GetSFB(TString meanminmax, TString Atagger, float Etamin, float Etamax)
{
  TF1 *tmpSFl = NULL;
  TString sEtamin = Form("%1.1f",Etamin);
  TString sEtamax = Form("%1.1f",Etamax);
...
//-----------------------------------------------
TF1* DelphesHandler::GetEffLight(TString meanminmax, TString Atagger, float Etamin, float Etamax)
{
  TF1 *tmpMistag = NULL;
  TString sEtamin = Form("%1.1f",Etamin);
  TString sEtamax = Form("%1.1f",Etamax);
...
//------------------------------------------------
TF1* DelphesHandler::GetEffC(TString meanminmax, TString Atagger, float Etamin, float Etamax)
{
  TF1 *tmpSFl = NULL;
  TString sEtamin = Form("%1.1f",Etamin);
  TString sEtamax = Form("%1.1f",Etamax);
