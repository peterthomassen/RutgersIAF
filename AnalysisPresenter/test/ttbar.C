void ttbar() {
	...
	assembler->project("NGOODJETS", true)->plot(false, true)->SaveAs("ttbar_NGOODJETS.pdf");
	assembler->project("HT", true)->plot(true, true)->SaveAs("ttbar_HT.pdf");
	assembler->project("MET", true)->plot(true, true)->SaveAs("ttbar_MET.pdf");
	assembler->project("ST", true)->plot(true, true)->SaveAs("ttbar_ST.pdf");
	assembler->setRange("ST", 300);
	assembler->project("NGOODJETS", true)->plot(false, true)->SaveAs("ttbar_NGOODJETS_STgt300.pdf");
	assembler->project("HT", true)->plot(true, true)->SaveAs("ttbar_HT_STgt300.pdf");
	assembler->project("MET", true)->plot(true, true)->SaveAs("ttbar_MET_STgt300.pdf");
	assembler->project("ST", true)->plot(true, true)->SaveAs("ttbar_ST_STgt300.pdf");
	assembler->setRange();
