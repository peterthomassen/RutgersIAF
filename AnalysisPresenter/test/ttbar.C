...
void ttbar() {
	...
	// for ttbar 2L
	std::string varexp = "NBJETSCSVM{0,2}:HT{0,1000,20}:MET{0,500,10}:ST{0,2000,20}:NGOODJETS{0,6}:NPROMPTNONISOINCLUSIVETRACKS7{0,15}:NGOODTRACKS{0,15}:NGOODINCLUSIVETRACKS{0,15}";
	
	// Global cuts, if desired
	TString selection = "NLEPTONS == 2 && NGOODELECTRONS == 1 && NGOODMUONS == 1 && NGOODTAUS == 0 && Sum$(QGOODELECTRONS) + Sum$(QGOODMUONS) == 0";
