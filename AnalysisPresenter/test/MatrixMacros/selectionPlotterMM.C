...
void selectionPlotterMM() {
  ...
  SaveHistograms(assembler->project("(Alt$(ISPROMPTMUON[2],0))",   true),"All_ISPROMPTMUON3.root");
  */
  //
  // --------------------------------------------------------------
  //
  assembler->project("(Alt$(PTGOODELECTRONS[0],0))",   true)->plot(true)->SaveAs("All_PTGOODELECTRONS1.pdf"); //  El Parameters 1
  SaveHistograms(assembler->project("(Alt$(PTGOODELECTRONS[0],0))",   true)->plot(true),"All_PTGOODELECTRONS1.root");
  ...
  //
  /*
  assembler->project("(Alt$(PTGOODELECTRONS[1],0))",   true)->plot(true)->SaveAs("All_PTGOODELECTRONS2.pdf"); //  El Parameters 2
  SaveHistograms(assembler->project("(Alt$(PTGOODELECTRONS[1],0))",   true)->plot(true),"All_PTGOODELECTRONS2.root");
  ...
  */
  //
  /*
  assembler->project("(Alt$(PTGOODELECTRONS[2],0))",   true)->plot(true)->SaveAs("All_PTGOODELECTRONS3.pdf"); //  El Parameters 3
  SaveHistograms(assembler->project("(Alt$(PTGOODELECTRONS[2],0))",   true)->plot(true),"All_PTGOODELECTRONS3.root");
