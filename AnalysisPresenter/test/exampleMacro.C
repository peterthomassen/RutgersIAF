...
void exampleMacro(TString ofname = "test.root") {
	...
	// Signal definition //
	///////////////////////
	PhysicsContribution* signal = new PhysicsContribution("signal", "/users/h2/heindl/simulation/histograms/tcH_ww.simulation.root", (0.01 * 245.8) * 0.0289, "SeesawTo3Lminus_SyncedMC");
