...
void setupProductsMatrix(BaseHandler* handler)
{
  ...
  //handler->addEventVariable("MATRIXWEIGHTS3D",MatrixWeights3D);//now we use LUTs
  ...
  //handler->addEventVariable("MATRIXWEIGHTS3DLA",MatrixWeights3DLA);//now we use LUTs
  ...
  //handler->addEventVariable("MATRIXWEIGHTS2D",MatrixWeights2D);//now we use LUTs
  ...
  //handler->addEventVariable("MATRIXWEIGHTS2DLA",MatrixWeights2DLA);//now we use LUTs
